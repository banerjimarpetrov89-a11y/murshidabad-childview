  ...
  return (
    <footer className="mt-20 border-t border-border bg-secondary/40">
      <div className="mx-auto max-w-7xl px-4 py-10 md:px-6 grid gap-8 md:grid-cols-4">
        <div>
          <div className="text-sm font-bold text-foreground">Murshidabad Child Protection</div>
          <p className="mt-2 text-xs leading-relaxed text-muted-foreground">
            Murshidabad District Administration ·
        ...
        <div>
          ...
          <div className="mt-2 rounded-md border border-border bg-card p-3 text-[11px] leading-relaxed text-muted-foreground">
            ...
            <p className="mt-1">Murshidabad District Administration ({new Date().getFullYear()}). <em>Murshidabad Child Protection Dashboard.</em> Public knowledge resource. Retrieved from this site.</p>
          </div>
        </div>
        <div>
      ...
      <div className="border-t border-border/60">
        <div className="mx-auto max-w-7xl px-4 py-4 md:px-6 text-[11px] text-muted-foreground flex flex-col md:flex-row gap-2 md:items-center md:justify-between">
          <span>© {new Date().getFullYear()} Murshidabad Child Protection · Built as a public good.</span>
